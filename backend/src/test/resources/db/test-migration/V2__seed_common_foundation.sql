...
(1,'UNIV001',NULL,'2026-01-01',NULL,'초기 시드',now(),now()),
(2,'COL001','UNIV001','2026-01-01',NULL,'초기 시드',now(),now()),
(3,'DEPT001','COL001','2026-01-01',NULL,'초기 시드',now(),now()),
(4,'OFF001','UNIV001','2026-01-01',NULL,'초기 시드',now(),now());
...
(2,'professor1','R01','POSITION_BASED','2026-01-01',NULL,'admin','ACTIVE',now(),now()),
(3,'professor1','R02','POSITION_BASED','2026-01-01',NULL,'admin','ACTIVE',now(),now()),
(4,'professor2','R01','POSITION_BASED','2026-01-01',NULL,'admin','ACTIVE',now(),now());
...
ALTER TABLE menu ALTER COLUMN menu_id RESTART WITH 101;
ALTER TABLE org_relation ALTER COLUMN relation_id RESTART WITH 101;
ALTER TABLE user_role ALTER COLUMN assignment_id RESTART WITH 101;
