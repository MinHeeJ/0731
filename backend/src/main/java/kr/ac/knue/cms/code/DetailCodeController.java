...
public class DetailCodeController {
    ...
    public ApiResponse<List<Map<String, Object>>> list(@PathVariable String groupId) {
        return ApiResponse.ok(mapper.listDetailCodes(groupId));
    }

    @GetMapping("/api/code-groups/{groupId}/detail-codes/tree")
    public ApiResponse<List<Map<String, Object>>> tree(@PathVariable String groupId) {
        return ApiResponse.ok(mapper.listDetailCodes(groupId));
    }
